...
export default function Home() {
  return <main>
    <section className="hero"><div className="hero-grid" aria-hidden="true" /><div className="shell hero-inner">
      ...
      <div className="app-showcase" aria-label="ตัวอย่างหน้าต่างโปรแกรม TR File Tools"><div className="showcase-top"><span className="mini-brand">TR</span><b>TR FILE TOOLS</b><div className="window-dots"><i /><i /><i /></div></div>
        <div className="showcase-body"><div className="tool-rail"><i /><i /><i /><i /></div><div className="tuning-panel"><div className="panel-head"><span>BATCH FILE TASK</span><small>LIVE PROGRESS</small></div><div className="chart-bars">{[48,70,58,88,74,96,81,66,77,53,69,42].map((h,i)=><i key={i} style={{height:`${h}%`}} />)}</div><div className="data-row"><span>FILES<strong>128</strong></span><span>DONE<strong>100%</strong></span><span>SAVED<strong>2.4 GB</strong></span></div></div></div>
        <div className="showcase-status"><span><i /> TASK COMPLETE</span><b>READY TO USE</b></div>
      </div>
    </div></section>
