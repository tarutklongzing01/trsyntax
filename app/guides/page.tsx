...
const guides=[
  ['วิธีติดตั้ง TR-SYNTAX DL บน Windows 11','Installation','28 ส.ค. 2026','1,248',HardDriveDownload],
  ['เริ่มดาวน์โหลดด้วย TR-SYNTAX DL','How To Use','25 ส.ค. 2026','986',Settings],
  ['ตั้งค่า Preset ให้ทำงานซ้ำได้เร็วขึ้น','Productivity','18 ส.ค. 2026','2,403',SlidersHorizontal],
  ['แก้ปัญหาโปรแกรมดาวน์โหลดไฟล์ไม่ได้','Troubleshooting','12 ส.ค. 2026','752',TriangleAlert],
];
